...
export const en: Translations = {
  meta: {
    title: 'Cross Base Shibuya - Premium Apartment in the Heart of Tokyo',
    description: 'Spacious apartment just 2 minutes from Shibuya Station. Two bedrooms, two bathrooms, fully equipped kitchenette in Tokyo city centre.',
  },
  nav: {
    home: 'Home',
